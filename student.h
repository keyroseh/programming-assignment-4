...
public:
    ...
    // Calculations
    double programAverage(int programs) const; // Programming assignment average
    double testAverage(int tests) const; // Exam average
    double finalGrade(int programmingW, int testsW, int finalW, int programs, int tests); //Weighted final grade, W = weight
